            ...
            <div class="card-wrapper">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <hr>
                  <form action="/siswa/{{$siswa->id}}" method="POST" class="needs-validation" novalidate="">
                    @method('PUT')
                    {{csrf_field()}}
                    <div class="form-row">
                      <div class="col-md-4 mb-3">
                        <label class="form-control-label" for="validationCustom01">Nisn</label>
                        <input name="nisn" type="text" class="form-control @error('nisn') is-invalid @enderror" id="validationCustom01" placeholder="nisn" required="" value="{{$siswa->nisn}}">
                        @error('nisn')
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <input name="nis" type="text" class="form-control @error('nis') is-invalid @enderror" id="validationCustom02" placeholder="Nis" required="" value="{{$siswa->nis}}">
                        @error('nis')
                        <div class="invalid-feedback">
                          harus berupa angka min-5 max-16
                        </div>
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <input name="nama" type="text" class="form-control @error('nama') is-invalid @enderror" id="validationCustomUsername" placeholder="Nama" aria-describedby="inputGroupPrepend" required="" value="{{$siswa->nama}}">
                        @error('nama')
                        <div class="invalid-feedback">
                          nama lengkap max-45
                        </div>
                    ...
                    <div class="form-row">
                      <div class="col-md-6 mb-3">
                        ...
                        <input name="alamat" type="text" class="form-control @error('alamat') is-invalid @enderror" id="validationCustom03" placeholder="Alamat" required="" value="{{$siswa->alamat}}">
                        @error('alamat')
                        <div class="invalid-feedback">
                      ...
                      <div class="col-md-3 mb-3">
                        ...
                        <input name="tlpn" type="text" class="form-control @error('tlpn') is-invalid @enderror" id="validationCustom04" placeholder="Tlpn" required="" value="{{$siswa->tlpn}}">
                        @error('tlpn')
                        <div class="invalid-feedback">
                      ...
                      <div class="col-md-3 mb-3">
                        ...
                        <input name="email" type="text" class="form-control @error('email') is-invalid @enderror" id="validationCustom04" placeholder="Tlpn" required="" value="{{$siswa->user->email}}">
                        @error('email')
                        <div class="invalid-feedback">
                          email telah digunakan atau tidak memenuhi syarat
                        </div>
                        @enderror
                      </div>
                    </div>
