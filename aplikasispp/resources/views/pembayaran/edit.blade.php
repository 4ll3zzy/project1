                ...
                <div class="card-wrapper">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <hr>
                            <form action="/pembayaran/{{$pembayaran->id}}" method="POST" class="needs-validation"
                                novalidate="">
                                @method('PUT')
                                {{csrf_field()}}
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label class="form-control-label" for="validationCustom02">Bayar</label>
                                        <input name="bayar" type="text" class="form-control"
                                            id="validationCustom02" placeholder="kompetensi"
