            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Halaman Tambah SPP</li>
                </ol>
              </nav>
            </div>
            ...
            <div class="card-wrapper">
              ...
              <div class="card">
                ...
                <div class="card-header">
                  <h3 class="mb-0">Tambah Data SPP</h3>
                </div>
                <!-- Card body -->
                <div class="card-body">
                  <div class="row">
                  ...
                  <hr>
                  <form action="/spp" method="POST" class="needs-validation" novalidate="">
                    {{csrf_field()}}
                    <div class="form-row">
                      <div class="col-md-4 mb-3">
                        <label class="form-control-label" for="validationCustom01">Tahun</label>
                        <input name="tahun" type="text" class="form-control @error('tahun') is-invalid @enderror" id="validationCustom01" placeholder="tidak boleh kosong"  required="">
                        @error('tahun')
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <input name="nominal" type="text" class="form-control @error('tahun') is-invalid @enderror" id="validationCustom02" placeholder="tidak boleh kosong" required="">
                        @error('nominal')
                        <div class="invalid-feedback">
